	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 _Color0_Instance = UNITY_ACCESS_INSTANCED_PROP(DancingKnob,_Color0);
...
Node;AmplifyShaderEditor.SimpleAddOpNode;58;-669.1292,-838.272;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
